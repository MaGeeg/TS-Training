...
let formatStringsOutput = formatStrings('LoginPage', 'UserName')
...
let formatStringsAnonymousOutput = formatStringsAnonymous('HomePage', 'UserName')
...
let formatStringsArrowOutput = formatStringsArrow('ContactPage','UserName')
